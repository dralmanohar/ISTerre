...
# ~ us_full  = truncate_field(us_m, mmax, mmax)
us_trunc = truncate_field(ut_m, mmax, mcut)
us_full  = truncate_field(ut_m, mmax, mmax)
...
spec_full  = spectra_2d(ut_m)
# ~ spec_trunc = spectra_2d(us_trunc)
# ~ spec_trunc_full = spectra_2d(us_full)

print ("spec_full = \t",spec_full.shape)
...
# ~ axes.loglog(x[1:], spec_trunc_full[1:,1000], 'g', lw = lw11, dashes = (4,2))
