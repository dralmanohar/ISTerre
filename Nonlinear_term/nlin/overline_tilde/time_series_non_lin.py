...
def compute_nonline_machine_learning(data_path=None, file_save=None, lcut=None, mcut=None):
    ...
    for i in range(no_sample):
        ...
        nlin1, nlin2, C, D, time = snapshot_nonline_computation(U, B, T, lcut=lcut, mcut=mcut, path = data_path, save_path = MYDIR, time_stamp=time_stamp)

        comput_truncated_nonlinear(nlin1, nlin2, C, D, lcut=lcut, mcut=mcut, data_path=data_path, save_path=MYDIR, time_stamp=time_stamp)
...
if __name__ == '__main__':
    ...
    data_path = '/nfs_scratch/sharmam/Nonlinear_term/data/data_manohar/sample_2000/data_1808_samples/'
    file_save = '/nfs_scratch/sharmam/Nonlinear_term/results/3D_nathanael/data_iter_move_1000_sample/'
